...
export const LoginComponent = () => {
  return (
    <section className="hero px-24" id="home">
      <div className="container">
        <p className="section-subtitle">StoryBlocks</p>

        <h2 className="h1 hero-title">
          Discover, create, and buy extraordinary story NFTs
        </h2>

        <p className="hero-text">
          Create your own unique stories and mint NFTs
        </p>
